...
//     try {
//         if (method === 'POST') {
//             const { name, email, description, profession, work1Title, work1Description, work2Title, work2Description, work3Title, work3Description, work4Title, work4Description } = req.body;
...
//                 res.status(200).json({ message: 'Profile updated successfully', profile: existingProfile });
//             } else {
//                 const profileDoc = await prof.create({ name, email, description, profession, work1Title, work1Description, work2Title, work2Description, work3Title, work3Description, work4Title, work4Description });
//                 res.status(200).json({ message: 'Profile created successfully', profile: profileDoc });
//             }
...
//         } else if (method === 'PUT') {
//             const { _id, name, email, description, profession, work1Title, work1Description, work2Title, work2Description, work3Title, work3Description, work4Title, work4Description } = req.body;
...
//             const updatedProfile = await prof.findByIdAndUpdate(
//                 _id,
//                 { name, email, description, profession, work1Title, work1Description, work2Title, work2Description, work3Title, work3Description, work4Title, work4Description },
//                 { new: true }
//             );
